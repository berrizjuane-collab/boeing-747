...
function parseArguments(argv) {
  ...
  return { files: files.length > 0 ? files : DEFAULT_FILES, assertRatio }
}
...
const { files, assertRatio } = parseArguments(process.argv.slice(2))
...
const report = { measurements, maxMeanRatio }
